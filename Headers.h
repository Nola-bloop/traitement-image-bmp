...
struct BMPInfoHeader {
    ...
    int32_t height{ 0 }; // Hauteur de l'image en pixels. Positive image commence en bas � gauche, N�gative image commence en haut � gauche
    uint16_t planes{ 1 }; //
...
{
    uint32_t red_mask{ 0x00ff0000 }; //0x000000ff
    uint32_t green_mask{ 0x0000ff00 }; //0x0000ff00
    uint32_t blue_mask{ 0x000000ff }; //0x00ff0000
